...
<%@ page import="com.israt.employees_database.entity.Student" %>
<%
student emp = (Employee)request.getAttribute("employee");
%>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="glass-form">
        ...
        <form action="employees?action=update" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control" name="dob" value="<%= emp.getDob() != null ? emp.getDob().toString() : "" %>" required>
            </div>
            <div class="mb-3">
            ...
            <div class="text-center">
                <input type="submit" class="btn btn-warning btn-lg me-2" value="Update Employee">
